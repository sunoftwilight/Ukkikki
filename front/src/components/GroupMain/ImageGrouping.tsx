...
const ImageGrouping: React.FC = () => {
  return (
    <div className="w-full h-[72px] flex rounded-xl bg-soft-gray items-center ps-[10px] overflow-x-auto overscroll-none">
      <div style={{ minWidth: `${groupingList.length * 64}px` }} className="flex gap-3">
