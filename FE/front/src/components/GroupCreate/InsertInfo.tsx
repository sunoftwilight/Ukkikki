...
import { InsertInfoProps } from "../../types/GroupType";

const InsertInfo: React.FC<InsertInfoProps> = ({
	onNextBtnClick,
	createData,
}) => {
		...
		<div className="flex flex-col w-full h-full items-center">
			...
			<div className="px-4 w-full">
				<input
					ref={inputNameRef}
					type="text"
					className="w-full h-[60px] bg-soft-gray rounded-2xl mb-3 text-xl font-pre-SB text-center outline-none"
